...
import com.buildtrack.dao.worker.WorkerDao;
...
public class WorkerService {
	...
	public List<WorkLog> getWorkerLogs(int workerId, String monthYear) {
		return workerDao.findByWorker(workerId, monthYear);
	}

	public List<Project> getAssignedProjects(int workerId) {
		return workerDao.findAssignedProjects(workerId);
	}
}
