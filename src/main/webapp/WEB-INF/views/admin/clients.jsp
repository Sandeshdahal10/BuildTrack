<%-- Created by IntelliJ IDEA. User: Dell Date: 4/15/2026 Time: 5:23 PM To change this template use File | Settings |
    File Templates. --%>
                            ...
                            <section>
                                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <p class="mt-1 text-slate-500">Manage and track all your construction clients.
                                        </p>
                                    </div>
                                    <a href="${pageContext.request.contextPath}/admin/clients/form"
                                        class="inline-flex items-center gap-2 self-start rounded-lg bg-orange-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-orange-600 sm:self-auto">
                                ...
                                <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                                    <jsp:include page="../common/statsCard.jsp">
                                        ...
                                        <jsp:param name="value"
                                            value="${empty userStats ? 0 : userStats.totalClients}" />
                                    ...
                                    <jsp:include page="../common/statsCard.jsp">
                                        ...
                                        <jsp:param name="value"
                                            value="${empty userStats ? 0 : userStats.pendingApprovals}" />
                                    ...
                                    <jsp:include page="../common/statsCard.jsp">
                                        ...
                                        <jsp:param name="value"
                                            value="${empty userStats ? 0 : userStats.totalWorkers}" />
                                    ...
                                    <c:forEach var="client" items="${clients}">
                                        ...
                                        <jsp:include page="../common/ClientCard.jsp">
                                            ...
                                            <jsp:param name="viewLink"
                                                value="${pageContext.request.contextPath}/admin/clients/${client.id}" />
                                            <jsp:param name="editLink"
                                                value="${pageContext.request.contextPath}/admin/clients/${client.id}/edit" />
                                        </jsp:include>
                                    </c:forEach>
                                </div>
                            </section>
